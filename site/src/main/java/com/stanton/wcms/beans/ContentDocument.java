...
@HippoEssentialsGenerated(internalName = "atLaw:contentdocument")
@Node(jcrType = "atLaw:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "atLaw:introduction")
    public String getIntroduction() {
        return getProperty("atLaw:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("atLaw:publicationdate");
    }
}
