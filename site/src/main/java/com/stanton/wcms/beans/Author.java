...
@Node(jcrType = "atLaw:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "atLaw:role";
    public static final String ACCOUNTS = "atLaw:accounts";
    public static final String FULL_NAME = "atLaw:fullname";
    public static final String IMAGE = "atLaw:image";
    public static final String CONTENT = "atLaw:content";

    @HippoEssentialsGenerated(internalName = "atLaw:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "atLaw:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "atLaw:accounts")
